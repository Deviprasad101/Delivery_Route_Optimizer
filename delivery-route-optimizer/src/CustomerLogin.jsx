...
const CustomerLogin = () => {
  ...
  const handleSubmitCredentials = async (e) => {
    ...
    try {
      ...
      const bodyData = { role: 'customer', username, password };
  ...
  return (
    <div className="min-h-screen bg-surface flex flex-col items-center justify-center p-md font-body-md antialiased overflow-hidden">
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        <div className="absolute top-[-20%] left-[-10%] w-[70%] h-[70%] bg-primary-container/20 rounded-full blur-[120px]"></div>
        <div className="absolute bottom-[-20%] right-[-10%] w-[60%] h-[60%] bg-secondary-container/20 rounded-full blur-[120px]"></div>
      </div>
      ...
      <div className="relative z-10 w-full max-w-[440px] flex flex-col items-center mb-xl">
        <div className="w-16 h-16 bg-primary text-on-primary rounded-2xl flex items-center justify-center mb-md shadow-sm">
          <span className="material-symbols-outlined text-[32px]" style={{ fontVariationSettings: "'FILL' 1" }}>local_mall</span>
        </div>
